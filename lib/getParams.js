...
const validate = r =>
{
  console.log('RESPOSTAAAAAAAAAAAAAAAA: ', r.statusCode)
  return validateRequest(r, 'Impossível capturar o captcha!')
}
...
const parseResponse = r =>
  buildResult(r.response, r.session);

const getParams = () =>
  firstRequest()
    .then(validate)
    .then(processSessionId)
    .then(getData)
    .then(validate)
    .then(parseResponse);
