...
const solvePromise = (resolve, reject, d = { type: 'error' }, args) => {
  let [c, m, s] = args;
  let _default = [(d.code || 2), (d.message || 'Erro interno!'), (d.status || 500)];
...
const promiseHandler = (data, ...args) =>
  new Promise((resolve, reject) =>
    solvePromise(resolve, reject, data, args));
