...
// Valida os números informados como CNPJ.
...
// Acessa a base da Receita Federal do Brasil e retorna as informações sobre o CNPJ como o corpo do site.
...
// Transforma string do modelo DD/MM/AAAA em Date.
...
// Transforma string do modelo X(...)X - X(...)X em objeto contando código como primeiro trecho antes do "-" e descrição como segundo.
...
// Objeto contendo o tratamento à ser feito em cada determinada informação.
function parserData() {
  return {
...
// Extrai as informações do corpo do site e aplica os tratamentos determinados.
...
// Agrupa toda a sequência de procedimentos para extrair, tratar e organizar os dados coletados do CNPJ informado.
